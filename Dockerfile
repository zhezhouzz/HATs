...
SHELL ["/bin/bash", "-lc"]
ARG CACHEBUST=1
RUN git clone https://github.com/mitchell-lang/ocaml5_parser.git && cd ocaml_parser && git pull origin ef47e625b5fa33497a3134f40db42ce8ffdbc134 && git checkout -b ef47e625b5fa33497a3134f40db42ce8ffdbc134 && opam install . && cd ..
...
RUN eval $(opam env)
RUN git clone https://github.com/mitchell-lang/normal5ty.git && cd normalty && git pull origin origin 2fef196bb91468b090b269b3bdef3e4946ac8fe4 && git checkout -b origin 2fef196bb91468b090b269b3bdef3e4946ac8fe4 && opam install . && cd ..
RUN eval $(opam env)
RUN git clone https://github.com/zhezhouzz/HATs.git
WORKDIR HATs
RUN git config pull.ff only
RUN git checkout pldi24-sm
RUN git pull origin 39d36066552321ce8540bd845d9e849e161552fa
RUN git checkout -b 39d36066552321ce8540bd845d9e849e161552fa
